...
-- The Unread filter is a third reading-list shape alongside the two 0002
-- indexes: newest-first over just the unread Entries, so the tab does not fall
-- back to a full scan of entries_published_at.
